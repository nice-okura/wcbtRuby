...
set title "Long resouces in all tasks" 
...
set ylabel "Long resources in all tasks"
...
GNUTERM = "x11"
set terminal png
set output "120411_plt_16tasks.png"
plot "pltdata_120411_16tasks.dat" using 1:2 title "16tasks 1group" w l, \
     "pltdata_120411_16tasks.dat" using 1:3 title "16tasks 2groups" w l, \
     "pltdata_120411_16tasks.dat" using 1:4 title "16tasks 4groups" w l, \
     "pltdata_120411_16tasks.dat" using 1:5 title "16tasks 8groups" w l
#    EOF
