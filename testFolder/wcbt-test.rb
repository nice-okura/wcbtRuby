...
=end
  ...
  def test_AB
    ...
    assert_equal(AB(TaskManager.get_task(5)))
    assert_equal(AB(TaskManager.get_task(6)))
    assert_equal(AB(TaskManager.get_task(7)))
    assert_equal(AB(TaskManager.get_task(8)))
    assert_equal(AB(TaskManager.get_task(9)))
    assert_equal(AB(TaskManager.get_task(10)))
    assert_equal(AB(TaskManager.get_task(11)))
    assert_equal(AB(TaskManager.get_task(12)))
    assert_equal(AB(TaskManager.get_task(13)))
    assert_equal(AB(TaskManager.get_task(14)))
    assert_equal(AB(TaskManager.get_task(15)))
    assert_equal(AB(TaskManager.get_task(16)))
  ...
  def test_ndbp
    ...
    assert_equal(0, ndbp(TaskManager.get_task(1), 1) )
    ...
    assert_equal(0, ndbp(TaskManager.get_task(2), 1) )
    assert_equal(0, ndbp(TaskManager.get_task(2), 3) )
    assert_equal(0, ndbp(TaskManager.get_task(2), 4) )
    assert_equal(0, ndbp(TaskManager.get_task(3), 1) )
    assert_equal(3, ndbp(TaskManager.get_task(3), 2) )
    assert_equal(4, ndbp(TaskManager.get_task(3), 4) )
    ...
    assert_equal(0, ndbp(TaskManager.get_task(13), 1) )
  ...
  def test_rblp
    set_taskset("#{TEST_FOLDER}for_test_LB_nest")
    assert_equal(14, rblp(TaskManager.get_task(1), 2) )
    assert_equal(26, rblp(TaskManager.get_task(1), 3) )
    assert_equal(0, rblp(TaskManager.get_task(1), 4) )
    assert_equal(0, rblp(TaskManager.get_task(2), 1) )
    assert_equal(0, rblp(TaskManager.get_task(2), 3) )
    assert_equal(0, rblp(TaskManager.get_task(2), 4) )
    assert_equal(0, rblp(TaskManager.get_task(3), 1) )
    assert_equal(18, rblp(TaskManager.get_task(3), 2) )
    assert_equal(35, rblp(TaskManager.get_task(3), 4) )
  end
