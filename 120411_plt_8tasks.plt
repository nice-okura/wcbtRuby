...
set title "Long resources in all task" 
...
GNUTERM = "x11"
set terminal png
set output "120411_plt.png"
plot "pltdata_120411_8tasks.dat" using 1:2 title "8tasks 1group" w l, \
     "pltdata_120411_8tasks.dat" using 1:3 title "8tasks 2groups" w l, \
     "pltdata_120411_8tasks.dat" using 1:4 title "8tasks 4groups" w l, \
     "pltdata_120411_8tasks.dat" using 1:5 title "8tasks 8groups" w l
#    EOF
