...
set title "Long resources in all tasks"
...
set ylabel "Long resources in all task" 
...
GNUTERM = "x11"
set terminal png
set output "120411_plt_12tasks.png"
plot "pltdata_120411_12tasks.dat" using 1:2 title "12tasks 1group" w l, \
     "pltdata_120411_12tasks.dat" using 1:3 title "12tasks 2groups" w l, \
     "pltdata_120411_12tasks.dat" using 1:4 title "12tasks 4groups" w l, \
     "pltdata_120411_12tasks.dat" using 1:5 title "12tasks 8groups" w l
#    EOF
