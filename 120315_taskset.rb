...
0.upto(100){
  ...
  task2 = Task.new(2, 2, 50, extime2, 2, 0, [@req2_1, @req2_2])
  task3 = Task.new(3, 1, 50, extime3, 3, 3, [@req3_1, @req3_2])
...
=end
  ...
  task6 = Task.new(2, 2, 50, extime2, 2, 0, [@req6_1, @req6_2])
  task7 = Task.new(3, 1, 50, extime3, 3, 3, [@req7_1, @req7_2])
