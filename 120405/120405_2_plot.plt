...
GNUTERM = "x11"
set terminal png
set output "120405_2_plot.png"
plot "120405_2_plot.dat" using 1:2 title "1 short resource" w l, \
     "120405_2_plot.dat" using 1:3 title "2 short resources" w l, \
     "120405_2_plot.dat" using 1:4 title "3 short resources" w l, \
     "120405_2_plot.dat" using 1:5 title "4 short resources" w l, \
     "120405_2_plot.dat" using 1:6 title "5 short resources" w l, \
     "120405_2_plot.dat" using 1:7 title "6 short resources" w l, \
     "120405_2_plot.dat" using 1:8 title "7 short resources" w l, \
     "120405_2_plot.dat" using 1:9 title "8 short resources" w l, \
     "120405_2_plot.dat" using 1:10 title "9 short resources" w l, \
     "120405_2_plot.dat" using 1:11 title "10 short resources" w l, \
     "120405_2_plot.dat" using 1:12 title "11 short resources" w l, \
     "120405_2_plot.dat" using 1:13 title "12 short resources" w l
